...
@Component({
  ...
  templateUrl: './creer-categorie-produit.component.html',
  styleUrls: ['./creer-categorie-produit.component.css'],
  standalone: false
})
export class CreerCategorieProduitComponent implements OnInit, OnDestroy {
